...
public class CourseScore {
	...
	public static void main(String[] args) {
		...
		System.out.println("Max Score 1: ");
		maxScore1 = input.nextDouble();
		System.out.println("Earned Score 1: ");
		score1 = input.nextDouble();
		System.out.println("Max Score 2: ");
		maxScore2 = input.nextDouble();
		System.out.println("Earned Score 2: ");
		score2 = input.nextDouble();
		System.out.println("Max Score 3: ");
		maxScore3 = input.nextDouble();
		System.out.println("Earned Score 3: ");
		score3 = input.nextDouble();
		System.out.println("Max Score 4: ");
		maxScore4 = input.nextDouble();
		System.out.println("Earned Score 4: ");
		...
		input.close(); // did not include this in the version that I turned in
